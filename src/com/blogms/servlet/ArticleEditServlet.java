...
import com.blogms.service.ArticleEditService;
...
//        System.out.println(title);
        ...
        User u = null;
        u = new User();
        u = (User) session.getAttribute("userInfo");  //获取到当前登录的对象
//        System.out.println(u.getUsername());
        ...
        switch (method) {
            ...
            case "edit_article": {
                ...
                //进行文章分类标签的增加
                //非空判断
                if (a == null || "".equals(a)) {//判定a是否为空两种1.情况没有填入 2.填入为空格 equals为判断两个字符串是否相等
                } else {
