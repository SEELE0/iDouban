...
import com.blogms.dao.ArticleEditDao;
import com.blogms.entity.Article;
import com.blogms.util.MyDataSource;
...
public class ArticleEditDaoImpl implements ArticleEditDao {
    ...
    public int articleInsert(Article article) {
        ...
        try {
            ...
            /*因为表中主键article_id设置了自动递增，即AUTO_INCREMENT，
            所以可以使用上述语句查询获取到最后一个插入表中的自增列的值。*/
            PreparedStatement stmt1 = con.prepareStatement(sql1);
            ResultSet rs = stmt1.executeQuery();

            if (rs.next())//结果不为空即插入成功
            {
