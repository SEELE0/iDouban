...
/**
 * @Description 将得到的图片文件名转化为图片在项目中的绝对地址 ="http://localhost:8080/blogtest/image/
 * @author 林泽鸿
...
public class ImageUrl
{
	 ...
	 * 项目名的目录+"/"
	 */
	private static  String guide = "http://localhost:8080/blogtest/image/";
	...
	/**
	 * @Description 字符串的拼接 加上项目名目录----- “http://localhost:8080/blogtest/image/ "+ "时间戳"+"随机数" + "." + "文件后缀名"
