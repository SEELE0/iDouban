...
<head>
    ...
    <!-- 登录成功之后，进行个人信息的修改 -->
    <!-- 导航栏 -->
    <link rel="stylesheet" type="text/css" href="http://localhost:8080/blogtest/css/header.css">
    <style type="text/css">
        /*放置主要的页面内容*/
        #main_content {
            /*width: 1040px;*/
...
<div id="main_content">
    <div id="main_content-left">
        ...
        <div id="main_content-left-top">
            ...
            <!-- 用户更换头像 -->
            <div>
                <form action="http://localhost:8080/blogtest/UploadServlet" method="post" enctype="multipart/form-data">
            ...
            <!-- 用作个人主页的信息展示 -->
            <div>
                <form action="http://localhost:8080/blogtest/MyPageServlet" method="post">
                    昵称： <input type="text" name="nickname"/><br/><br/>
                    个性签名：<input type="text" name="signature"/><br/><br/>
                    自我介绍：<input type="text" name="selfIntroduc"/><br/><br/>
