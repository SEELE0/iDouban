...
<head>
    ...
    <style type="text/css">
        body {
            ...
            background-image: url('http://localhost:8080/blogtest/image/%E7%99%BB%E5%BD%95%E8%83%8C%E6%99%AF.png');
            /*background-image: url('http://localhost:8080/iDouban/image/登陆背景.png');*/
    ...
    <div id="login">
        ...
        <div id="verify" class="login_level">
            ...
            <div class="verify_inner">
                ...
                <img src="VerifyCodeServlet" width="80" height="42" id="verify_pic">
            </div>
        </div>
        ...
        <div>
<%--            <a href="http://localhost:8080/blogtest/jsp/send_mail.jsp" id="login_bottom_find"><font color=blue>忘记密码</font></a>--%>
            <a href="http://localhost:8080/blogtest/jsp/register.jsp" id="login_bottom_sign"><font color=blue>注册账号</font></a>
        </div>
...
<c:if test="${not empty cookie.auto.value}">
    <!-- 重定位到登陆界面 -->
    <c:redirect url="http://localhost:8080/Blogms/jsp/alter.jsp"/>
</c:if>
...
<script type="text/javascript">
    ...
    document.getElementById("btn").onclick = function () {
        ...
        document.getElementsByTagName("img")[0].src =
            "/Blogms/VerifyCodeServlet?time=" + new Date().getTime();
    };
</script>
