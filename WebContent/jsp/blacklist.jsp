						 	...
						 	<c:forEach  items="${requestScope.p.objects}" var="u">
						 		...
						 		<div class="users_info_list">
						 			...
						 			<div id="everyone_list_operation">
						 				<a href="FriendListServlet?pre_method=remove_black&method=blacklist_list&toUserId=${u.userId}&currentPage=${requestScope.p.currentPage}" class="operation">从黑名单中去除</a>
						 			</div>
						 		</div>
						 	</c:forEach>
						</div>
