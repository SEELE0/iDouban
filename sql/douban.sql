/*
 ...
 Source Host           : localhost:8080/blogtest
...
(
    ...
    `portrait`          varchar(200) CHARACTER SET utf8 COLLATE utf8_general_ci NULL     DEFAULT 'http://localhost:8080/blogtest/image/default.png' COMMENT '用户头像（存储路径）',
